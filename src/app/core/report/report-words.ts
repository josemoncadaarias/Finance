...
export const REPORT_KEYS = [
  ...
  'report.yields.note.stale',
  'report.yields.note.estimated.on',
  'report.yields.note.estimated.between',
  'report.yields.net.withEstimate',
  'report.yields.estimated',
  'report.yields.estimatedNote',
  'report.yields.effectiveNote.withEstimate',
  'report.yields.estimatedRow',
  'report.yields.note.estimated',
  'report.yields.inflation.one',
  'report.yields.inflation.borrowed',
  'report.yields.inflation.keptNote.withEstimate',
  'report.about.headline',
  'report.about.versus',
  'report.about.jumps',
  'report.about.categories',
  'report.about.categories-versus',
  ...
  'report.yields.about.inflation',
  'report.yields.about.growth',
  'report.yields.about.soFar',
  'report.yields.about.byAccount',
  'report.yields.about.byProduct',
  'report.yields.about.byMonth',
  'report.yields.about.versusBefore',
