...
`,
  ...
  {
    version: 41,
    name: 'each_product_earns_from_its_own_day',
    file: '041_each_product_earns_from_its_own_day.sql',
    sql: `-- Migration 041 - the day it starts earning belongs to the product
--
...
`,
  ...
  {
    version: 42,
    name: 'the_cushion_tables_become_the_products',
    file: '042_the_cushion_tables_become_the_products.sql',
    sql: `-- Migration 042 - the two tables named after the cushion take their real names
--
...
`,
  ...
  {
    version: 43,
    name: 'a_pocket_is_a_product',
    file: '043_a_pocket_is_a_product.sql',
    sql: `-- Migration 043 - a pocket is a product
--
...
`,
  ...
  {
    version: 44,
    name: 'movements_the_app_proposes',
    file: '044_movements_the_app_proposes.sql',
    sql: `-- Migration 044 - a movement the app proposes, which only a person makes real
--
...
`,
  ...
  {
    version: 45,
    name: 'a_guess_is_not_a_memory',
    file: '045_a_guess_is_not_a_memory.sql',
    sql: `-- Migration 045 - a category the app guessed is not a category it remembered
--
...
`,
  ...
  {
    version: 46,
    name: 'the_consumer_price_index',
    file: '046_the_consumer_price_index.sql',
    sql: `-- Migration 046 - the consumer price index, to say whether money kept its value
--
...
`,
  ...
  {
    version: 47,
    name: 'a_category_can_be_an_investment_return',
    file: '047_a_category_can_be_an_investment_return.sql',
    sql: `-- Migration 047 - a category can say it is what an investment earned or lost
--
