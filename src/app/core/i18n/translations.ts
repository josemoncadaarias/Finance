...
export const SPANISH = {
  ...
  'cushion.pocket.deleteYieldToo': 'Y tiene {amount} en rendimientos, que pasan al mismo producto.',
  'cushion.pocket.deleteYieldOnly': 'Este producto tiene {amount} en rendimientos. ¿A qué producto pasan?',
  'cushion.pockets.yield': 'Rendimientos: {amount}',
...
export const ENGLISH: Record<TranslationKey, string> = {
  ...
  'cushion.pocket.deleteYieldToo': 'It also has {amount} in yields, which go to the same product.',
  'cushion.pocket.deleteYieldOnly': 'This product has {amount} in yields. Which product do they go to?',
  'cushion.pockets.yield': 'Yields: {amount}',
