...
export const SPANISH = {
  ...
  'cushion.rate.pocket': '¿Para cuál producto es esta tasa?',
  'cushion.rate.everyPocket': 'Todos los productos',
...
export const ENGLISH: Record<TranslationKey, string> = {
  ...
  'cushion.rate.pocket': 'Which product is this rate for?',
  'cushion.rate.everyPocket': 'Every product',
