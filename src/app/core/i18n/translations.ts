...
export const SPANISH = {
  ...
  'cushion.title': 'Colchón',
  'cushion.total': 'Colchón acumulado',
  ...
  'cushion.days.hint': 'Toca un día para ver cómo se calculó y corregirlo contra el extracto.',
  ...
  'cushion.detail.total': 'Disponible en el colchón',
  'cushion.part.opening': 'Saldo inicial',
  ...
  'cushion.pockets': 'Alcancías',
  'cushion.pockets.count': '{count} alcancías',
  'cushion.pockets.ledger': 'Toma el saldo de la cuenta',
  'cushion.pockets.manual': 'Saldo escrito a mano',
  'cushion.pockets.add': 'Agregar una alcancía o bolsillo',
  'cushion.pockets.hint': 'Si el banco parte la cuenta en varias, agrégalas aquí: el banco le paga a cada una por aparte y la retefuente se mide sobre cada una, no sobre la suma.',
  'cushion.pocket.name': 'Nombre',
  'cushion.pocket.namePlaceholder': 'Alcancía, bolsillo, meta…',
  ...
  'cushion.pocket.from': 'Medido el',
  'cushion.pocket.delete': 'Eliminar esta alcancía',
  'cushion.error.name': 'Ponle un nombre.',
  'cushion.error.lastPocket': 'Una cuenta necesita al menos una alcancía.',
  'cushion.pockets.drift': 'Las alcancías y el saldo de la cuenta no cuadran por {amount}. Actualiza los saldos de las alcancías.',
  'cushion.rates': 'Tasas',
  ...
  'cushion.rate.percent': 'Tasa efectiva anual (%)',
  'cushion.rate.from': 'Válida desde',
  'cushion.rate.spend': 'Solo si gastas al mes (opcional)',
  'cushion.rate.fallback': 'Tasa si no se cumple (%)',
  ...
  'nav.cushion': 'Colchón',
  'nav.cushion.hint': 'Rendimientos y cashback aparte',
...
export const ENGLISH: Record<TranslationKey, string> = {
  ...
  // --- the cushion: yields and cashback ---------------------------------
  'cushion.title': 'Cushion',
  'cushion.total': 'Accumulated cushion',
  ...
  'cushion.days.hint': 'Tap a day to see how it was worked out and correct it against the statement.',
  ...
  'cushion.detail.total': 'Available in the cushion',
  'cushion.part.opening': 'Opening figure',
  ...
  'cushion.pockets': 'Pockets',
  'cushion.pockets.count': '{count} pockets',
  'cushion.pockets.ledger': 'Follows the account balance',
  'cushion.pockets.manual': 'Balance typed in',
  'cushion.pockets.add': 'Add a pocket',
  'cushion.pockets.hint': 'If the bank splits the account into several, add them here: it pays each one separately, and the withholding is measured on each rather than on the total.',
  'cushion.pocket.name': 'Name',
  'cushion.pocket.namePlaceholder': 'Pocket, goal, space…',
  ...
  'cushion.pocket.from': 'Measured on',
  'cushion.pocket.delete': 'Remove this pocket',
  'cushion.error.name': 'Give it a name.',
  'cushion.error.lastPocket': 'An account needs at least one pocket.',
  'cushion.pockets.drift': 'The pockets and the account balance disagree by {amount}. Update the pocket balances.',
  'cushion.rates': 'Rates',
  ...
  'cushion.rate.percent': 'Effective annual rate (%)',
  'cushion.rate.from': 'Valid from',
  'cushion.rate.spend': 'Only if you spend monthly (optional)',
  'cushion.rate.fallback': 'Rate when it is not met (%)',
  ...
  'nav.cushion': 'Cushion',
  'nav.cushion.hint': 'Interest and cashback, kept apart',
