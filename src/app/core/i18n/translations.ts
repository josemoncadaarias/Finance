...
export const SPANISH = {
  ...
  'cushion.pocket.cdtHint': 'Un CDT no rinde día a día: se paga de una vez en cada fecha de pago, sobre el saldo que tenga ese día. Aunque su tasa diga "Todos los días", se paga cada mes, o cada cuántos meses diga la tasa.',
...
export const ENGLISH: Record<TranslationKey, string> = {
  ...
  'cushion.pocket.cdtHint': 'A CDT does not earn day by day: it is paid all at once on each payday, on the balance it holds that day. Even if its rate says "Every day", it is paid every month, or every as many months as the rate says.',
