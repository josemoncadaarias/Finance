...
export const SPANISH = {
  ...
  'cushion.earnsOn.today': 'El rendimiento de hoy se calculó sobre {amount}, que es lo que había al cerrar ayer.',
...
export const ENGLISH: Record<TranslationKey, string> = {
  ...
  'cushion.earnsOn.today': "Today's yield was worked out on {amount}, which is what was there when yesterday closed.",
