...
export const SPANISH = {
  ...
  'cushion.entry': 'Agregar ingreso o gasto',
  'cushion.entry.hint': 'Plata que entra o sale de los rendimientos de un producto: cashback, una corrección contra lo que pagó el banco, o lo que quieras anotar. No cambia el saldo de la cuenta ni tu patrimonio. Desde esa fecha los rendimientos se recalculan con el saldo nuevo.',
  'cushion.entry.kind': '¿Qué es?',
  'cushion.entry.direction': '¿Es un ingreso o un gasto?',
...
export const ENGLISH: Record<TranslationKey, string> = {
  ...
  'cushion.entry': 'Add income or an expense',
  'cushion.entry.hint': 'Money coming into or going out of a product\'s yields: cashback, a correction against what the bank paid, or anything you want to note down. It does not change the account balance or your net worth. From that date the yields are worked out again on the new balance.',
  ...
  'cushion.entry.direction': 'Is it income or an expense?',
