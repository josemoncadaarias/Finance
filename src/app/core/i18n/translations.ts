...
export const SPANISH = {
  ...
  'cushion.payments.hint': 'Lo que el banco realmente abona: cada día si la tasa es diaria, a fin de mes si es mensual. Esta es la lista para comparar contra la app del banco.',
...
export const ENGLISH: Record<TranslationKey, string> = {
  ...
  'cushion.payments.hint': 'What the bank actually hands over: every day for a daily rate, at the end of the month for a monthly one. This is the list to hold beside the bank app.',
