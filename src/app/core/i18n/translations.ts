...
export const SPANISH = {
  ...
  'cushion.pocket.deleteKeeps': 'Sus movimientos y lo que ha ganado pasan a {target}: no se pierde plata ni rendimientos.',
...
export const ENGLISH: Record<TranslationKey, string> = {
  ...
  'cushion.pocket.deleteKeeps': 'Its movements and what it has earned go to {target}: no money or yield is lost.',
