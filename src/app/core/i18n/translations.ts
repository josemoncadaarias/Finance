...
export const SPANISH = {
  ...
  'cushion.payout.months': '¿Cada cuántos meses paga?',
  'cushion.payout.monthsHint': 'Paga el último día del mes. 1 es cada mes, 6 cada seis meses, 12 una vez al año. Los meses se cuentan desde el mes de la fecha "Desde".',
...
export const ENGLISH: Record<TranslationKey, string> = {
  ...
  'cushion.payout.months': 'Every how many months does it pay?',
  'cushion.payout.monthsHint': 'It pays on the last day of the month. 1 is every month, 6 every six months, 12 once a year. Months are counted from the month of the "From" date.',
